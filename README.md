...
```
bash <(curl -s https://raw.githubusercontent.com/tallbacka/tallbacka-nvim/master/utils/install.sh)
```
...
```
git clone https://github.com/tallbacka/tallbacka-nvim.git ~/.config/nvim
```
